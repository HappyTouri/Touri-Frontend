...
export const GetALLCoutries = createAsyncThunk(
  "countryy/get-all",
  async (thunkAPI) => {
    try {
      return getAllItems();
...
export const countrySlice = createSlice({
  ...
  extraReducers: (builder) => {
    builder
      ...
      // Get all Status
      .addCase(GetALLCoutries.pending, (state) => {
        state.isLoading = true;
      })
      .addCase(GetALLCoutries.fulfilled, (state, action) => {
        state.isLoading = false;
        state.isSuccess = true;
        state.isError = false;
        state.data = action.payload;
      })
      .addCase(GetALLCoutries.rejected, (state, action) => {
        state.isLoading = false;
...
export const { setItem } = countrySlice.actions;
